...
val eol : unit -> string [@@js.global "os.eol"]

val arch : unit -> string [@@js.global "os.arch"]

val constants : Constant.t [@@js.global "os.constants"]

val cpus : unit -> CPU.t list [@@js.global "os.cpus"]

val endianness : unit -> string [@@js.global "os.endianness"]

val freemem : unit -> int [@@js.global "os.freemem"]

val getPriority : ?pid:int -> unit -> int [@@js.global "os.getPriority"]

val homedir : unit -> string [@@js.global "os.homedir"]

val hostname : unit -> string [@@js.global "os.hostname"]

val loadavg : unit -> int list [@@js.global "os.loadavg"]

val networkInterfaces : unit -> NetworkInterface.t list
  [@@js.global "os.networkInterfaces"]

val platform : unit -> string [@@js.global "os.platform"]

val release : unit -> string [@@js.global "os.release"]

val setPriority : ?pid:int -> priority:int -> unit
  [@@js.global "os.setPriority"]

val tmpdir : unit -> string [@@js.global "os.tmpdir"]

val totalmem : unit -> int [@@js.global "os.totalmem"]

val type_ : unit -> string [@@js.global "os.type"]

val uptime : unit -> int [@@js.global "os.uptime"]

module UserInfoOptions = struct
  type t = private Ojs.t [@@js]
...
val userInfo : ?options:UserInfoOptions.t -> unit -> UserInfo.t
  [@@js.global "os.userInfo"]

val version : unit -> string [@@js.global "os.version"]
